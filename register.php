          ...
          <form method="POST" action="success1.php">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="text" id="Department" class="form-control" placeholder="Department" name="Department" required="required" autofocus="autofocus">
                    <label for="Department">Department</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="text" id="Position" class="form-control" placeholder="Position" name="Position" required="required">
